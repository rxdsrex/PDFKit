...
const modifyPdf = async (pdfFileLocation, chapters) => {
    try {
        const existingPdfStr = await (0, utils_1.readFile)(pdfFileLocation);
        const pdfDoc = await pdf_lib_1.PDFDocument.load(existingPdfStr);
